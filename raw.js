...
//____________________________________ON_GUILD_CREATE__________EVENT
 ...
 module.exports.onGuildCreate=async(client)=>{try{
   ...
   if(exports.fetch_members){
      if(module.exports.log) console.log('Fetching members from servers ');
      let guilds_keys= client.guilds.keyArray();
      for(let i=0;i<guilds_keys.length;i++){ 
           await client.guilds.get(guilds_keys[i]).fetchMembers()
              .then()
              .catch(console.error);
       };
    };
